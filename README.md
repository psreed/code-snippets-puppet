...
# --==[ execwindowscmd.pp ]==--
<b>Exec Windows Command (cmd.exe & powershell.exe examples)</b>
<p>
...
# --==[ jre8viaarchive.pp ]==--
<b>Java JRE 8 via Archive Module (.tar.gz extraction on Windows)</b>
<p>
...
# --==[ user-data.epp ]==--
<b>Amazon EC2 UserData EPP Template Example</b>
<p>
